...
class Config(object):
    ...
    SHORTENER = bool(os.environ.get('SHORTENER')) # Set False If you want shortlink off else True
    SHORTENER_URL = os.environ.get('SHORTENER_URL', 'linkrex.net') # your shortlink url domain or url without https://
    SHORTENER_API = os.environ.get('SHORTENER_API', 'bcf8fc3fd10fce3224cdadc7713e22d51dd46570') # your url shortner api

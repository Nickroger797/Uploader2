...
class Config(object):
    ...
    SHORTENER = bool(environ.get('SHORTNER', True)) # Set False If you want shortlink off else True
    SHORTENER_URL = environ.get('URL', 'linkrex.net') # your shortlink url domain or url without https://
    SHORTENER_API = environ.get('API', 'bcf8fc3fd10fce3224cdadc7713e22d51dd46570') # your url shortner api
